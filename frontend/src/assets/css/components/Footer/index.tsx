    ...
    <div>
      <footer className="footer mt-auto py-3 bg-dark">
        <div className="container">
          ...
          <p className="text-light"><small><strong>Documentação completa do projeto no Notion </strong><br />
            Disponível em: <a href="https://abrir.link/gSh33" target="_blank" rel="noreferrer">Notion Project Spring Boot React</a></small></p>
        </div>
      </footer>
